...
String currentLang = "en";
  ...
  Widget _buildFollowersState() {
    //print("translate activities for $currentLang => ${AppLanguage.translate('activities', currentLang)}");
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            _buildStatColumn("1250",
             AppLanguage.translate('activities', currentLang)),
            Padding(
