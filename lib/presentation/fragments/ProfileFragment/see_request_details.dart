...
class SeeRequestDetails extends StatefulWidget {
  final String email;
  const SeeRequestDetails({
    super.key,
    required this.email,
  });

  @override
  State<SeeRequestDetails> createState() => _SeeRequestDetailsState();
}

class _SeeRequestDetailsState extends State<SeeRequestDetails> {
  String name = '';
  String location = '';
  String? userEmail;
  Image? profileImage;
